...
- (void)createNavigationBar
{
    ...
    cancelButton.frame = CGRectMake(10, 0, 70, 35);
    ...
    UIButton *cropButton = [UIButton buttonWithType:UIButtonTypeSystem];
    cropButton.frame = CGRectMake(0, 0, 70, 35);
    [cropButton setTitle:@"Crop" forState:UIControlStateNormal];
    [cropButton setTitleColor:[UIColor colorWithRed:255 / 255.f  green:206 / 255.f blue:121 / 255.f alpha:1.f] forState:UIControlStateNormal];
    [cropButton addTarget:self action:@selector(done:) forControlEvents:UIControlEventTouchUpInside];
    
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:cropButton];
